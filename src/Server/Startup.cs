...
namespace FaceManagement.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<TensorflowServiceSettings>(Configuration.GetSection("TensorflowService"));

            services.AddDbContext<FaceContext>(opt => 
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                FileProvider = new PhysicalFileProvider(Contracts.ImagesFolderPath),
                RequestPath = "/img"
            });
        }
    }
